...
namespace UnityEngine.UIElements.StyleSheets
{
	...
	{
		// Token: 0x0600277B RID: 10107 RVA: 0x0009DFE0 File Offset: 0x0009C1E0
		public static bool TryGetEnumIntValue(StyleEnumType enumType, string value, out int intValue)
		{
			...
			{
				bool flag75 = string.Equals(value, "upper-left", StringComparison.OrdinalIgnoreCase);
				if (flag75)
				{
					intValue = 0;
					return true;
				}
				bool flag76 = string.Equals(value, "upper-center", StringComparison.OrdinalIgnoreCase);
				if (flag76)
				{
					intValue = 1;
					return true;
				}
				bool flag77 = string.Equals(value, "upper-right", StringComparison.OrdinalIgnoreCase);
				if (flag77)
				{
					intValue = 2;
					return true;
				}
				bool flag78 = string.Equals(value, "middle-left", StringComparison.OrdinalIgnoreCase);
				if (flag78)
				{
					intValue = 3;
					return true;
				}
				bool flag79 = string.Equals(value, "middle-center", StringComparison.OrdinalIgnoreCase);
				if (flag79)
				{
					intValue = 4;
					return true;
				}
				bool flag80 = string.Equals(value, "middle-right", StringComparison.OrdinalIgnoreCase);
				if (flag80)
				{
					intValue = 5;
					return true;
				}
				bool flag81 = string.Equals(value, "lower-left", StringComparison.OrdinalIgnoreCase);
				if (flag81)
				{
					intValue = 6;
					return true;
				}
				bool flag82 = string.Equals(value, "lower-center", StringComparison.OrdinalIgnoreCase);
				if (flag82)
				{
					intValue = 7;
					return true;
				}
				bool flag83 = string.Equals(value, "lower-right", StringComparison.OrdinalIgnoreCase);
				if (flag83)
				{
					intValue = 8;
					return true;
			...
			{
				bool flag84 = string.Equals(value, "advanced", StringComparison.OrdinalIgnoreCase);
				if (flag84)
				{
					intValue = 1;
					return true;
				}
				bool flag85 = string.Equals(value, "standard", StringComparison.OrdinalIgnoreCase);
				if (flag85)
				{
					intValue = 0;
					return true;
			...
			{
				bool flag86 = string.Equals(value, "clip", StringComparison.OrdinalIgnoreCase);
				if (flag86)
				{
					intValue = 0;
					return true;
				}
				bool flag87 = string.Equals(value, "ellipsis", StringComparison.OrdinalIgnoreCase);
				if (flag87)
				{
					intValue = 1;
					return true;
			...
			{
				bool flag88 = string.Equals(value, "start", StringComparison.OrdinalIgnoreCase);
				if (flag88)
				{
					intValue = 1;
					return true;
				}
				bool flag89 = string.Equals(value, "middle", StringComparison.OrdinalIgnoreCase);
				if (flag89)
				{
					intValue = 2;
					return true;
				}
				bool flag90 = string.Equals(value, "end", StringComparison.OrdinalIgnoreCase);
				if (flag90)
				{
					intValue = 0;
					return true;
			...
			{
				bool flag91 = string.Equals(value, "left", StringComparison.OrdinalIgnoreCase);
				if (flag91)
				{
					intValue = 1;
					return true;
				}
				bool flag92 = string.Equals(value, "right", StringComparison.OrdinalIgnoreCase);
				if (flag92)
				{
					intValue = 2;
					return true;
				}
				bool flag93 = string.Equals(value, "top", StringComparison.OrdinalIgnoreCase);
				if (flag93)
				{
					intValue = 3;
					return true;
				}
				bool flag94 = string.Equals(value, "bottom", StringComparison.OrdinalIgnoreCase);
				if (flag94)
				{
					intValue = 4;
					return true;
				}
				bool flag95 = string.Equals(value, "center", StringComparison.OrdinalIgnoreCase);
				if (flag95)
				{
					intValue = 5;
					return true;
			...
			{
				bool flag96 = string.Equals(value, "visible", StringComparison.OrdinalIgnoreCase);
				if (flag96)
				{
					intValue = 0;
					return true;
				}
				bool flag97 = string.Equals(value, "hidden", StringComparison.OrdinalIgnoreCase);
				if (flag97)
				{
					intValue = 1;
					return true;
			...
			{
				bool flag98 = string.Equals(value, "normal", StringComparison.OrdinalIgnoreCase);
				if (flag98)
				{
					intValue = 0;
					return true;
				}
				bool flag99 = string.Equals(value, "nowrap", StringComparison.OrdinalIgnoreCase);
				if (flag99)
				{
					intValue = 1;
					return true;
				}
				bool flag100 = string.Equals(value, "pre", StringComparison.OrdinalIgnoreCase);
				if (flag100)
				{
					intValue = 2;
					return true;
				}
				bool flag101 = string.Equals(value, "pre-wrap", StringComparison.OrdinalIgnoreCase);
				if (flag101)
				{
					intValue = 3;
					return true;
			...
			{
				bool flag102 = string.Equals(value, "nowrap", StringComparison.OrdinalIgnoreCase);
				if (flag102)
				{
					intValue = 0;
					return true;
				}
				bool flag103 = string.Equals(value, "wrap", StringComparison.OrdinalIgnoreCase);
				if (flag103)
				{
					intValue = 1;
					return true;
				}
				bool flag104 = string.Equals(value, "wrap-reverse", StringComparison.OrdinalIgnoreCase);
				if (flag104)
				{
					intValue = 2;
					return true;
		...
		// Token: 0x0600277C RID: 10108 RVA: 0x0009ECA8 File Offset: 0x0009CEA8
		...
		// Token: 0x0600277D RID: 10109 RVA: 0x0009EE40 File Offset: 0x0009D040
