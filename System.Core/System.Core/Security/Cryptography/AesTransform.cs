...
namespace System.Security.Cryptography
{
	...
	{
		// Token: 0x06000052 RID: 82 RVA: 0x00002600 File Offset: 0x00000800
			...
			: base(algo, encryption, iv)
		{
			...
			for (int j = this.Nk; j < num2; j++)
			{
				...
				if (j % this.Nk == 0)
				{
					uint num6 = (num5 << 8) | ((num5 >> 24) & 255U);
					num5 = this.SubByte(num6) ^ AesTransform.Rcon[j / this.Nk];
				}
		...
		// Token: 0x06000053 RID: 83 RVA: 0x000028B3 File Offset: 0x00000AB3
		...
		// Token: 0x06000054 RID: 84 RVA: 0x000028DC File Offset: 0x00000ADC
		...
		// Token: 0x06000055 RID: 85 RVA: 0x00002938 File Offset: 0x00000B38
		...
		// Token: 0x06000056 RID: 86 RVA: 0x000035A0 File Offset: 0x000017A0
		...
		private static readonly byte[] iSBox = new byte[]
		{
			...
			155, 47, byte.MaxValue, 135, 52, 142, 67, 68, 196, 222,
