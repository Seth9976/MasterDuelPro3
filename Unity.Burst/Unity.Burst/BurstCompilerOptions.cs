...
namespace Unity.Burst
{
	...
	{
		// Token: 0x06000053 RID: 83 RVA: 0x0000282D File Offset: 0x00000A2D
		...
		{
			string[] set = SafeStringArrayHelper.DeserialiseStringArraySafe(from);
			return new ValueTuple<string[], string[], string>(SafeStringArrayHelper.DeserialiseStringArraySafe(set[0]), SafeStringArrayHelper.DeserialiseStringArraySafe(set[1]), set[2]);
		}

		// Token: 0x06000055 RID: 85 RVA: 0x0000287C File Offset: 0x00000A7C
		private BurstCompilerOptions()
			: this(false)
		{
		}

		// Token: 0x06000056 RID: 86 RVA: 0x00002885 File Offset: 0x00000A85
		...
		// (get) Token: 0x06000057 RID: 87 RVA: 0x000028A2 File Offset: 0x00000AA2
		private bool IsGlobal { get; }

		// Token: 0x1700000C RID: 12
		// (get) Token: 0x06000058 RID: 88 RVA: 0x000028AA File Offset: 0x00000AAA
		...
		// (get) Token: 0x06000059 RID: 89 RVA: 0x000028BE File Offset: 0x00000ABE
		// (set) Token: 0x0600005A RID: 90 RVA: 0x000028C8 File Offset: 0x00000AC8
		...
		// (get) Token: 0x0600005B RID: 91 RVA: 0x00002916 File Offset: 0x00000B16
		// (set) Token: 0x0600005C RID: 92 RVA: 0x0000291E File Offset: 0x00000B1E
		...
		// (get) Token: 0x0600005D RID: 93 RVA: 0x0000293B File Offset: 0x00000B3B
		// (set) Token: 0x0600005E RID: 94 RVA: 0x00002943 File Offset: 0x00000B43
		...
		// (get) Token: 0x0600005F RID: 95 RVA: 0x00002966 File Offset: 0x00000B66
		// (set) Token: 0x06000060 RID: 96 RVA: 0x0000296E File Offset: 0x00000B6E
		...
		// (get) Token: 0x06000061 RID: 97 RVA: 0x00002991 File Offset: 0x00000B91
		// (set) Token: 0x06000062 RID: 98 RVA: 0x00002999 File Offset: 0x00000B99
		...
		// (get) Token: 0x06000063 RID: 99 RVA: 0x000024DA File Offset: 0x000006DA
		// (set) Token: 0x06000064 RID: 100 RVA: 0x000024D5 File Offset: 0x000006D5
		...
		// (get) Token: 0x06000065 RID: 101 RVA: 0x000024D7 File Offset: 0x000006D7
		// (set) Token: 0x06000066 RID: 102 RVA: 0x000024D5 File Offset: 0x000006D5
		...
		// (get) Token: 0x06000067 RID: 103 RVA: 0x000029BC File Offset: 0x00000BBC
		// (set) Token: 0x06000068 RID: 104 RVA: 0x000029C4 File Offset: 0x00000BC4
		...
		// (get) Token: 0x06000069 RID: 105 RVA: 0x000029E1 File Offset: 0x00000BE1
		...
		// (get) Token: 0x0600006A RID: 106 RVA: 0x000029F2 File Offset: 0x00000BF2
		// (set) Token: 0x0600006B RID: 107 RVA: 0x000029FA File Offset: 0x00000BFA
		...
		// Token: 0x0600006D RID: 109 RVA: 0x00002A5E File Offset: 0x00000C5E
		...
		// Token: 0x0600006E RID: 110 RVA: 0x00002A7D File Offset: 0x00000C7D
		...
		// Token: 0x0600006F RID: 111 RVA: 0x00002A9C File Offset: 0x00000C9C
		private static BurstCompileAttribute GetBurstCompileAttribute(MemberInfo memberInfo)
		{
			BurstCompileAttribute result = memberInfo.GetCustomAttribute<BurstCompileAttribute>();
			if (result != null)
			{
				return result;
			}
		...
		// Token: 0x06000070 RID: 112 RVA: 0x00002B2C File Offset: 0x00000D2C
		internal static bool HasBurstCompileAttribute(MemberInfo member)
		{
			...
			return BurstCompilerOptions.TryGetAttribute(member, out attr);
		}
		...
		// Token: 0x06000072 RID: 114 RVA: 0x00002C54 File Offset: 0x00000E54
		...
		{
			flagsOut = null;
			BurstCompileAttribute memberAttribute;
			if (!BurstCompilerOptions.TryGetAttribute(member, out memberAttribute))
			{
				return false;
			}
			BurstCompileAttribute assemblyAttribute;
			if (BurstCompilerOptions.TryGetAttribute(member.Module.Assembly, out assemblyAttribute))
			{
				BurstCompilerOptions.MergeAttributes(ref memberAttribute, in assemblyAttribute);
			}
			flagsOut = this.GetOptions(memberAttribute, isForILPostProcessing, isForCompilerClient);
			return true;
		}

		// Token: 0x06000073 RID: 115 RVA: 0x00002C9C File Offset: 0x00000E9C
		...
		{
			StringBuilder flagsBuilderOut = new StringBuilder();
			if (!isForCompilerClient && ((attr != null && attr.CompileSynchronously) || this.RequiresSynchronousCompilation))
			{
				BurstCompilerOptions.AddOption(flagsBuilderOut, BurstCompilerOptions.GetOption("enable-synchronous-compilation", null));
			}
			BurstCompilerOptions.AddOption(flagsBuilderOut, BurstCompilerOptions.GetOption("debug=", "LineOnly"));
			if (isForILPostProcessing)
			{
				BurstCompilerOptions.AddOption(flagsBuilderOut, BurstCompilerOptions.GetOption("compilation-priority=", CompilationPriority.ILPP));
			}
			if (attr != null)
			{
				if (attr.FloatMode != FloatMode.Default)
				{
					BurstCompilerOptions.AddOption(flagsBuilderOut, BurstCompilerOptions.GetOption("float-mode=", attr.FloatMode));
				}
				if (attr.FloatPrecision != FloatPrecision.Standard)
				{
					BurstCompilerOptions.AddOption(flagsBuilderOut, BurstCompilerOptions.GetOption("float-precision=", attr.FloatPrecision));
				}
				if (attr.DisableSafetyChecks)
				{
					BurstCompilerOptions.AddOption(flagsBuilderOut, BurstCompilerOptions.GetOption("disable-safety-checks", null));
				}
				if (attr.Options != null)
				{
					foreach (string option in attr.Options)
					{
						if (!string.IsNullOrEmpty(option))
						{
							BurstCompilerOptions.AddOption(flagsBuilderOut, option);
						}
					}
				}
				...
				case OptimizeFor.Balanced:
					BurstCompilerOptions.AddOption(flagsBuilderOut, BurstCompilerOptions.GetOption("opt-level=", 2));
					break;
				case OptimizeFor.Performance:
					BurstCompilerOptions.AddOption(flagsBuilderOut, BurstCompilerOptions.GetOption("opt-level=", 3));
					break;
				case OptimizeFor.Size:
					BurstCompilerOptions.AddOption(flagsBuilderOut, BurstCompilerOptions.GetOption("opt-for-size", null));
					BurstCompilerOptions.AddOption(flagsBuilderOut, BurstCompilerOptions.GetOption("opt-level=", 3));
					break;
				case OptimizeFor.FastCompilation:
					BurstCompilerOptions.AddOption(flagsBuilderOut, BurstCompilerOptions.GetOption("opt-level=", 1));
					break;
				}
			}
			if (this.ForceEnableBurstSafetyChecks)
			{
				BurstCompilerOptions.AddOption(flagsBuilderOut, BurstCompilerOptions.GetOption("global-safety-checks-setting=", GlobalSafetyChecksSettingKind.ForceOn));
			}
			else if (this.EnableBurstSafetyChecks)
			{
				BurstCompilerOptions.AddOption(flagsBuilderOut, BurstCompilerOptions.GetOption("global-safety-checks-setting=", GlobalSafetyChecksSettingKind.On));
			}
			else
			{
				BurstCompilerOptions.AddOption(flagsBuilderOut, BurstCompilerOptions.GetOption("global-safety-checks-setting=", GlobalSafetyChecksSettingKind.Off));
			}
			if (this.EnableBurstTimings)
			{
				BurstCompilerOptions.AddOption(flagsBuilderOut, BurstCompilerOptions.GetOption("log-timings", null));
			}
			if (this.EnableBurstDebug || (attr != null && attr.Debug))
			{
				BurstCompilerOptions.AddOption(flagsBuilderOut, BurstCompilerOptions.GetOption("debugMode", null));
			}
			BurstCompilerOptions.AddOption(flagsBuilderOut, BurstCompilerOptions.GetOption("temp-folder=", Path.Combine(Environment.CurrentDirectory, "Temp", "Burst")));
			return flagsBuilderOut.ToString();
		}

		// Token: 0x06000074 RID: 116 RVA: 0x00002EEA File Offset: 0x000010EA
		...
		// Token: 0x06000075 RID: 117 RVA: 0x00002F05 File Offset: 0x00001105
		...
		// Token: 0x06000076 RID: 118 RVA: 0x00002F36 File Offset: 0x00001136
		...
		// Token: 0x06000077 RID: 119 RVA: 0x000024D5 File Offset: 0x000006D5
		private void MaybeTriggerRecompilation()
		{
		}

		// Token: 0x06000078 RID: 120 RVA: 0x00002F48 File Offset: 0x00001148
		static BurstCompilerOptions()
		{
			foreach (string arg in Environment.GetCommandLineArgs())
			{
				if (!(arg == "--burst-disable-compilation"))
				{
					if (arg == "--burst-force-sync-compilation")
					{
			...
			string disableCompilation = Environment.GetEnvironmentVariable("UNITY_BURST_DISABLE_COMPILATION");
		...
		// Token: 0x06000079 RID: 121 RVA: 0x000024DA File Offset: 0x000006DA
