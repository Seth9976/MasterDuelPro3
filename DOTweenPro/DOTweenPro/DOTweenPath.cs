...
namespace DG.Tweening
{
	...
	public class DOTweenPath : ABSAnimationComponent
	{
		...
		private static void Dispatch_OnReset(DOTweenPath path)
		{
			...
			{
				DOTweenPath.OnReset.Invoke(path);
			}
		}
		...
		private void Awake()
		{
			...
			{
				DOTweenPath._miCreateTween = DOTweenUtils.GetLooseScriptType("DG.Tweening.DOTweenModuleUtils+Physics").GetMethod("CreateDOTweenPathTween", 24);
			}
			...
			TweenerCore<Vector3, Path, PathOptions> tweenerCore = (TweenerCore<Vector3, Path, PathOptions>)DOTweenPath._miCreateTween.Invoke(null, new object[] { this, this.tweenRigidbody, this.isLocal, this.path, this.duration, this.pathMode });
			...
			case OrientType.ToPath:
				...
				{
					tweenerCore.SetLookAt(this.lookAhead, default(Vector3?), default(Vector3?));
				}
				break;
			case OrientType.LookAtTransform:
				if (this.lookAtTransform != null)
				{
					...
					{
						tweenerCore.SetLookAt(this.lookAtTransform, default(Vector3?), default(Vector3?));
					}
				}
				break;
			case OrientType.LookAtPosition:
				...
				{
					tweenerCore.SetLookAt(this.lookAtPosition, default(Vector3?), default(Vector3?));
				}
				break;
			}
			tweenerCore.SetTarget(base.gameObject);
			tweenerCore.SetDelay(this.delay).SetLoops(this.loops, this.loopType).SetAutoKill(this.autoKill)
				.SetUpdate(this.updateType)
				.OnKill(delegate
				{
					this.tween = null;
				});
		...
		// Token: 0x0600000A RID: 10 RVA: 0x00002793 File Offset: 0x00000993
		private void Reset()
		{
		...
		// Token: 0x0600000C RID: 12 RVA: 0x000027EE File Offset: 0x000009EE
		...
		// Token: 0x0600000E RID: 14 RVA: 0x0000280B File Offset: 0x00000A0B
		...
		// Token: 0x06000010 RID: 16 RVA: 0x00002821 File Offset: 0x00000A21
		public override void DOPlayForward()
		{
			this.tween.PlayForward();
		}

		// Token: 0x06000011 RID: 17 RVA: 0x0000282E File Offset: 0x00000A2E
		...
		// Token: 0x06000013 RID: 19 RVA: 0x00002849 File Offset: 0x00000A49
		public override void DORewind()
		{
			this.tween.Rewind(true);
		}

		// Token: 0x06000014 RID: 20 RVA: 0x00002857 File Offset: 0x00000A57
		...
		// Token: 0x06000016 RID: 22 RVA: 0x000028B3 File Offset: 0x00000AB3
		...
		// Token: 0x06000018 RID: 24 RVA: 0x000028CE File Offset: 0x00000ACE
		public void DOKillAllById(string id)
		{
			DOTween.Kill(id, false);
		}

		// Token: 0x06000019 RID: 25 RVA: 0x000028D8 File Offset: 0x00000AD8
		...
		// Token: 0x0600001A RID: 26 RVA: 0x0000292C File Offset: 0x00000B2C
		...
		// Token: 0x0600001B RID: 27 RVA: 0x00002980 File Offset: 0x00000B80
