...
namespace Novell.Directory.Ldap.Extensions
{
	...
	{
		// Token: 0x060004BE RID: 1214 RVA: 0x00014CB8 File Offset: 0x00012EB8
			...
			: base("2.16.840.1.113719.1.27.100.98", null)
		{
			try
			{
				...
				{
					Asn1Integer asn1Integer2 = new Asn1Integer(array[j]);
				...
				asn1OctetString3.encode(lberencoder, memoryStream);
				asn1Sequence.encode(lberencoder, memoryStream);
