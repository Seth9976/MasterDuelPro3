...
namespace Unity.Properties
{
	...
	{
		// Token: 0x06000159 RID: 345 RVA: 0x00005AAA File Offset: 0x00003CAA
		static TypeConversion()
		{
			TypeConversion.PrimitiveConverters.Register();
		}

		// Token: 0x0600015A RID: 346 RVA: 0x00005ABD File Offset: 0x00003CBD
		...
		public static TDestination Convert<TSource, TDestination>(ref TSource value)
		{
			...
			bool flag = !TypeConversion.TryConvert<TSource, TDestination>(ref value, out destination);
			if (flag)
			{
		...
		// Token: 0x0600015C RID: 348 RVA: 0x00005B28 File Offset: 0x00003D28
		public unsafe static bool TryConvert<TSource, TDestination>(ref TSource source, out TDestination destination)
		{
			Delegate converter;
			bool flag = TypeConversion.s_GlobalConverters.TryGetConverter(typeof(TSource), typeof(TDestination), out converter);
			bool flag2;
			if (flag)
			{
				...
				else
				{
					...
					if (isNullable)
					{
						...
						else
						{
							...
							if (isEnum)
							{
								...
								object value = global::System.Convert.ChangeType(source, enumUnderlyingType);
					...
					else
					{
						...
						else
						{
							...
							TDestination assignable;
							bool flag11;
							if (tsource is TDestination)
							{
								assignable = tsource as TDestination;
								flag11 = true;
							}
							else
							{
		...
		// Token: 0x0600015D RID: 349 RVA: 0x00005E7C File Offset: 0x0000407C
		private static bool TryConvertToUnityEngineObject<TSource, TDestination>(TSource source, out TDestination destination)
		{
			bool flag = !typeof(global::UnityEngine.Object).IsAssignableFrom(typeof(TDestination));
			bool flag2;
			if (flag)
			{
				destination = default(TDestination);
			...
			{
				bool flag3 = typeof(global::UnityEngine.Object).IsAssignableFrom(typeof(TSource)) || source is global::UnityEngine.Object;
				if (flag3)
				{
					...
					bool flag5 = typeof(TDestination) == typeof(global::UnityEngine.Object);
					if (flag5)
					{
						destination = (TDestination)((object)source);
						return true;
				...
				Delegate converter;
				bool flag6 = TypeConversion.s_GlobalConverters.TryGetConverter(typeof(TSource), typeof(global::UnityEngine.Object), out converter);
				if (flag6)
				{
					global::UnityEngine.Object unityObject = ((TypeConverter<TSource, global::UnityEngine.Object>)converter)(ref source);
		...
		// Token: 0x0600015E RID: 350 RVA: 0x00005F98 File Offset: 0x00004198
		...
		{
			// Token: 0x0600015F RID: 351 RVA: 0x00005FC4 File Offset: 0x000041C4
			...
			// Token: 0x06000160 RID: 352 RVA: 0x00006064 File Offset: 0x00004264
			...
			// Token: 0x06000161 RID: 353 RVA: 0x0000635C File Offset: 0x0000455C
			...
			// Token: 0x06000162 RID: 354 RVA: 0x00006654 File Offset: 0x00004854
			...
			// Token: 0x06000163 RID: 355 RVA: 0x0000694C File Offset: 0x00004B4C
			...
			// Token: 0x06000164 RID: 356 RVA: 0x00006C44 File Offset: 0x00004E44
			...
			// Token: 0x06000166 RID: 358 RVA: 0x00007234 File Offset: 0x00005434
			...
			// Token: 0x06000167 RID: 359 RVA: 0x0000752C File Offset: 0x0000572C
			...
			// Token: 0x06000168 RID: 360 RVA: 0x00007824 File Offset: 0x00005A24
			...
			// Token: 0x06000169 RID: 361 RVA: 0x00007B1C File Offset: 0x00005D1C
			...
			// Token: 0x0600016A RID: 362 RVA: 0x00007E14 File Offset: 0x00006014
			...
			// Token: 0x0600016B RID: 363 RVA: 0x0000810C File Offset: 0x0000630C
			...
			// Token: 0x0600016C RID: 364 RVA: 0x00008480 File Offset: 0x00006680
			private static void RegisterStringConverters()
			{
				...
				TypeConversion.s_GlobalConverters.Register(typeof(string), typeof(bool), new TypeConverter<string, bool>(delegate(ref string v)
				{
					...
					{
						double fromDouble;
						flag2 = double.TryParse(v, out fromDouble) && TypeConversion.Convert<double, bool>(ref fromDouble);
					}
					return flag2;
				}));
				...
				{
					sbyte r2;
					bool flag3 = sbyte.TryParse(v, out r2);
					sbyte b;
					if (flag3)
					{
						b = r2;
					...
					{
						double fromDouble2;
						b = (double.TryParse(v, out fromDouble2) ? TypeConversion.Convert<double, sbyte>(ref fromDouble2) : 0);
					}
					return b;
				}));
				...
				{
					short r3;
					bool flag4 = short.TryParse(v, out r3);
					short num;
					if (flag4)
					{
						num = r3;
					...
					{
						double fromDouble3;
						num = (double.TryParse(v, out fromDouble3) ? TypeConversion.Convert<double, short>(ref fromDouble3) : 0);
					}
					return num;
				}));
				...
				{
					int r4;
					bool flag5 = int.TryParse(v, out r4);
					int num2;
					if (flag5)
					{
						num2 = r4;
					...
					{
						double fromDouble4;
						num2 = (double.TryParse(v, out fromDouble4) ? TypeConversion.Convert<double, int>(ref fromDouble4) : 0);
					}
					return num2;
				}));
				...
				{
					long r5;
					bool flag6 = long.TryParse(v, out r5);
					long num3;
					if (flag6)
					{
						num3 = r5;
					...
					{
						double fromDouble5;
						num3 = (double.TryParse(v, out fromDouble5) ? TypeConversion.Convert<double, long>(ref fromDouble5) : 0L);
					}
					return num3;
				}));
				...
				{
					byte r6;
					bool flag7 = byte.TryParse(v, out r6);
					byte b2;
					if (flag7)
					{
						b2 = r6;
					...
					{
						double fromDouble6;
						b2 = (double.TryParse(v, out fromDouble6) ? TypeConversion.Convert<double, byte>(ref fromDouble6) : 0);
					}
					return b2;
				}));
				...
				{
					ushort r7;
					bool flag8 = ushort.TryParse(v, out r7);
					ushort num4;
					if (flag8)
					{
						num4 = r7;
					...
					{
						double fromDouble7;
						num4 = (double.TryParse(v, out fromDouble7) ? TypeConversion.Convert<double, ushort>(ref fromDouble7) : 0);
					}
					return num4;
				}));
				...
				{
					uint r8;
					bool flag9 = uint.TryParse(v, out r8);
					uint num5;
					if (flag9)
					{
						num5 = r8;
					...
					{
						double fromDouble8;
						num5 = (double.TryParse(v, out fromDouble8) ? TypeConversion.Convert<double, uint>(ref fromDouble8) : 0U);
					}
					return num5;
				}));
				...
				{
					ulong r9;
					bool flag10 = ulong.TryParse(v, out r9);
					ulong num6;
					if (flag10)
					{
						num6 = r9;
					...
					{
						double fromDouble9;
						num6 = (double.TryParse(v, out fromDouble9) ? TypeConversion.Convert<double, ulong>(ref fromDouble9) : 0UL);
					}
					return num6;
				}));
				...
				{
					float r10;
					bool flag11 = float.TryParse(v, out r10);
					float num7;
					if (flag11)
					{
						num7 = r10;
					...
					{
						double fromDouble10;
						num7 = (double.TryParse(v, out fromDouble10) ? TypeConversion.Convert<double, float>(ref fromDouble10) : 0f);
					}
					return num7;
				}));
