...
namespace SevenZip.Compression.LZMA
{
	...
	{
		// Token: 0x06000073 RID: 115 RVA: 0x00004068 File Offset: 0x00002268
		public Decoder()
		{
		...
		// Token: 0x06000074 RID: 116 RVA: 0x00004160 File Offset: 0x00002360
		...
		// Token: 0x06000075 RID: 117 RVA: 0x000041B8 File Offset: 0x000023B8
		...
		// Token: 0x06000076 RID: 118 RVA: 0x000041F0 File Offset: 0x000023F0
		...
		// Token: 0x06000077 RID: 119 RVA: 0x00004238 File Offset: 0x00002438
		...
		// Token: 0x06000078 RID: 120 RVA: 0x00004388 File Offset: 0x00002588
		...
		// Token: 0x06000079 RID: 121 RVA: 0x00004774 File Offset: 0x00002974
		public void SetDecoderProperties(byte[] properties)
		{
			...
			for (int i = 0; i < 4; i++)
			{
				num5 += (uint)((uint)properties[1 + i] << i * 8);
			}
		...
		// Token: 0x0600007A RID: 122 RVA: 0x00004800 File Offset: 0x00002A00
		...
		{
			// Token: 0x0600007B RID: 123 RVA: 0x00004828 File Offset: 0x00002A28
			...
			// Token: 0x0600007C RID: 124 RVA: 0x00004878 File Offset: 0x00002A78
			public void Init()
			{
				this.m_Choice.Init();
			...
			public uint Decode(Decoder rangeDecoder, uint posState)
			{
				...
				if (flag)
				{
					num = this.m_LowCoder[(int)posState].Decode(rangeDecoder);
				}
				else
				{
					uint num2 = 8U;
					...
					if (flag2)
					{
						num2 += this.m_MidCoder[(int)posState].Decode(rangeDecoder);
					}
					else
					{
						num2 += 8U;
						num2 += this.m_HighCoder.Decode(rangeDecoder);
					}
					num = num2;
				}
				return num;
		...
		{
			// Token: 0x0600007F RID: 127 RVA: 0x000049C4 File Offset: 0x00002BC4
			...
			// Token: 0x06000080 RID: 128 RVA: 0x00004A54 File Offset: 0x00002C54
			public void Init()
			{
				uint num = 1U << this.m_NumPrevBits + this.m_NumPosBits;
				for (uint num2 = 0U; num2 < num; num2 += 1U)
			...
			// Token: 0x06000081 RID: 129 RVA: 0x00004A98 File Offset: 0x00002C98
			private uint GetState(uint pos, byte prevByte)
			{
				return ((pos & this.m_PosMask) << this.m_NumPrevBits) + (uint)(prevByte >> 8 - this.m_NumPrevBits);
			}

			// Token: 0x06000082 RID: 130 RVA: 0x00004ACC File Offset: 0x00002CCC
			...
			// Token: 0x06000083 RID: 131 RVA: 0x00004AF8 File Offset: 0x00002CF8
			...
			{
				// Token: 0x06000085 RID: 133 RVA: 0x00004B25 File Offset: 0x00002D25
				public void Create()
				{
					this.m_Decoders = new BitDecoder[768];
				}

				// Token: 0x06000086 RID: 134 RVA: 0x00004B38 File Offset: 0x00002D38
				public void Init()
				{
					for (int i = 0; i < 768; i++)
					{
				...
				// Token: 0x06000087 RID: 135 RVA: 0x00004B6C File Offset: 0x00002D6C
				...
				// Token: 0x06000088 RID: 136 RVA: 0x00004BA8 File Offset: 0x00002DA8
