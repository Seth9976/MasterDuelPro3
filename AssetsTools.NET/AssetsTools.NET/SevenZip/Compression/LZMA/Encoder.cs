...
namespace SevenZip.Compression.LZMA
{
	...
	{
		// Token: 0x06000089 RID: 137 RVA: 0x00004C30 File Offset: 0x00002E30
		static Encoder()
		{
			int num = 2;
		...
		private static uint GetPosSlot(uint pos)
		{
			...
			if (flag)
			{
				num = (uint)Encoder.g_FastPos[(int)pos];
			}
			else
			{
				...
				if (flag2)
				{
					num = (uint)(Encoder.g_FastPos[(int)(pos >> 10)] + 20);
				}
				else
				{
					num = (uint)(Encoder.g_FastPos[(int)(pos >> 20)] + 40);
				}
			}
			return num;
		}

		// Token: 0x0600008B RID: 139 RVA: 0x00004D10 File Offset: 0x00002F10
		private static uint GetPosSlot2(uint pos)
		{
			...
			if (flag)
			{
				num = (uint)(Encoder.g_FastPos[(int)(pos >> 6)] + 12);
			}
			else
			{
				...
				if (flag2)
				{
					num = (uint)(Encoder.g_FastPos[(int)(pos >> 16)] + 32);
				}
				else
				{
					num = (uint)(Encoder.g_FastPos[(int)(pos >> 26)] + 52);
				}
			}
			return num;
		}

		// Token: 0x0600008C RID: 140 RVA: 0x00004D68 File Offset: 0x00002F68
		...
		// Token: 0x0600008D RID: 141 RVA: 0x00004DA4 File Offset: 0x00002FA4
		private void Create()
		{
		...
		// Token: 0x0600008E RID: 142 RVA: 0x00004E60 File Offset: 0x00003060
		public Encoder()
		{
			int num = 0;
		...
		// Token: 0x0600008F RID: 143 RVA: 0x0000505B File Offset: 0x0000325B
		private void SetWriteEndMarkerMode(bool writeEndMarker)
		{
			this._writeEndMark = writeEndMarker;
		}

		// Token: 0x06000090 RID: 144 RVA: 0x00005068 File Offset: 0x00003268
		private void Init()
		{
			this.BaseInit();
		...
		// Token: 0x06000092 RID: 146 RVA: 0x0000525C File Offset: 0x0000345C
		...
		// Token: 0x06000093 RID: 147 RVA: 0x00005290 File Offset: 0x00003490
		...
		// Token: 0x06000094 RID: 148 RVA: 0x000052D4 File Offset: 0x000034D4
		...
		// Token: 0x06000095 RID: 149 RVA: 0x0000539C File Offset: 0x0000359C
		...
		// Token: 0x06000096 RID: 150 RVA: 0x000053CC File Offset: 0x000035CC
		...
		// Token: 0x06000097 RID: 151 RVA: 0x00005434 File Offset: 0x00003634
		...
		// Token: 0x06000098 RID: 152 RVA: 0x00005574 File Offset: 0x00003774
		private uint GetOptimum(uint position, out uint backRes)
		{
			...
			else
			{
				...
				if (flag2)
				{
					this.ReadMatchDistances(out longestMatchLength, out num3);
				}
				else
				{
				...
				uint num4 = this._matchFinder.GetNumAvailableBytes() + 1U;
				bool flag3 = num4 < 2U;
				if (flag3)
				{
				...
				else
				{
					...
					{
						this.reps[(int)num6] = this._repDistances[(int)num6];
						this.repLens[(int)num6] = this._matchFinder.GetMatchLen(-1, this.reps[(int)num6], 273U);
						bool flag5 = this.repLens[(int)num6] > this.repLens[(int)num5];
						if (flag5)
						{
							num5 = num6;
						}
					}
					bool flag6 = this.repLens[(int)num5] >= this._numFastBytes;
					if (flag6)
					{
						backRes = num5;
						uint num7 = this.repLens[(int)num5];
						this.MovePos(num7 - 1U);
						num2 = num7;
					}
					else
					{
						...
						else
						{
							...
							else
							{
								...
								uint num8 = position & this._posStateMask;
								this._optimum[1].Price = this._isMatch[(int)((this._state.Index << 4) + num8)].GetPrice0() + this._literalEncoder.GetSubCoder(position, this._previousByte).GetPrice(!this._state.IsCharState(), b2, b);
								this._optimum[1].MakeAsChar();
								uint num9 = this._isMatch[(int)((this._state.Index << 4) + num8)].GetPrice1();
								uint num10 = num9 + this._isRep[(int)this._state.Index].GetPrice1();
								bool flag9 = b2 == b;
								if (flag9)
								{
									uint num11 = num10 + this.GetRepLen1Price(this._state, num8);
									bool flag10 = num11 < this._optimum[1].Price;
									if (flag10)
									{
										this._optimum[1].Price = num11;
										this._optimum[1].MakeAsShortRep();
									}
								}
								uint num12 = ((longestMatchLength >= this.repLens[(int)num5]) ? longestMatchLength : this.repLens[(int)num5]);
								bool flag11 = num12 < 2U;
								if (flag11)
								{
								...
								else
								{
									...
									do
									{
										this._optimum[(int)num13--].Price = 268435455U;
									}
									while (num13 >= 2U);
									for (uint num6 = 0U; num6 < 4U; num6 += 1U)
									{
										uint num14 = this.repLens[(int)num6];
										bool flag12 = num14 < 2U;
										if (!flag12)
										{
											uint num15 = num10 + this.GetPureRepPrice(num6, this._state, num8);
											do
											{
												uint num16 = num15 + this._repMatchLenEncoder.GetPrice(num14 - 2U, num8);
												Encoder.Optimal optimal = this._optimum[(int)num14];
												bool flag13 = num16 < optimal.Price;
												if (flag13)
												{
													optimal.Price = num16;
													optimal.PosPrev = 0U;
									...
									uint num17 = num9 + this._isRep[(int)this._state.Index].GetPrice0();
									num13 = ((this.repLens[0] >= 2U) ? (this.repLens[0] + 1U) : 2U);
									bool flag14 = num13 <= longestMatchLength;
									if (flag14)
									{
										uint num18 = 0U;
										while (num13 > this._matchDistances[(int)num18])
										{
											num18 += 2U;
										}
										for (;;)
										{
											uint num19 = this._matchDistances[(int)(num18 + 1U)];
											uint num20 = num17 + this.GetPosLenPrice(num19, num13, num8);
											Encoder.Optimal optimal2 = this._optimum[(int)num13];
											bool flag15 = num20 < optimal2.Price;
											if (flag15)
											{
												optimal2.Price = num20;
												optimal2.PosPrev = 0U;
												optimal2.BackPrev = num19 + 4U;
												optimal2.Prev1IsChar = false;
											}
											bool flag16 = num13 == this._matchDistances[(int)num18];
											if (flag16)
											{
												num18 += 2U;
												bool flag17 = num18 == num3;
												if (flag17)
												{
													break;
												}
									...
									{
										num21 += 1U;
										bool flag18 = num21 == num12;
										if (flag18)
										{
											break;
										}
										this.ReadMatchDistances(out num22, out num3);
										bool flag19 = num22 >= this._numFastBytes;
										if (flag19)
										{
											goto Block_26;
										}
										position += 1U;
										uint num23 = this._optimum[(int)num21].PosPrev;
										bool prev1IsChar = this._optimum[(int)num21].Prev1IsChar;
										Base.State state;
										if (prev1IsChar)
										{
											num23 -= 1U;
											bool prev = this._optimum[(int)num21].Prev2;
											if (prev)
											{
												state = this._optimum[(int)this._optimum[(int)num21].PosPrev2].State;
												bool flag20 = this._optimum[(int)num21].BackPrev2 < 4U;
												if (flag20)
												{
													state.UpdateRep();
												}
											...
											{
												state = this._optimum[(int)num23].State;
											}
											state.UpdateChar();
										}
										else
										...
										bool flag21 = num23 == num21 - 1U;
										if (flag21)
										{
											bool flag22 = this._optimum[(int)num21].IsShortRep();
											if (flag22)
											{
										...
										{
											bool flag23 = this._optimum[(int)num21].Prev1IsChar && this._optimum[(int)num21].Prev2;
											uint num24;
											if (flag23)
											{
												num23 = this._optimum[(int)num21].PosPrev2;
												num24 = this._optimum[(int)num21].BackPrev2;
												state.UpdateRep();
											}
											else
											{
												num24 = this._optimum[(int)num21].BackPrev;
												bool flag24 = num24 < 4U;
												if (flag24)
												{
													state.UpdateRep();
												}
											...
											Encoder.Optimal optimal3 = this._optimum[(int)num23];
											bool flag25 = num24 < 4U;
											if (flag25)
											{
												bool flag26 = num24 == 0U;
												if (flag26)
												{
											...
											{
												this.reps[0] = num24 - 4U;
												this.reps[1] = optimal3.Backs0;
												this.reps[2] = optimal3.Backs1;
												this.reps[3] = optimal3.Backs2;
											}
										}
										this._optimum[(int)num21].State = state;
										this._optimum[(int)num21].Backs0 = this.reps[0];
										this._optimum[(int)num21].Backs1 = this.reps[1];
										this._optimum[(int)num21].Backs2 = this.reps[2];
										this._optimum[(int)num21].Backs3 = this.reps[3];
										uint price = this._optimum[(int)num21].Price;
										b = this._matchFinder.GetIndexByte(-1);
										b2 = this._matchFinder.GetIndexByte((int)(0U - this.reps[0] - 1U - 1U));
										num8 = position & this._posStateMask;
										uint num25 = price + this._isMatch[(int)((state.Index << 4) + num8)].GetPrice0() + this._literalEncoder.GetSubCoder(position, this._matchFinder.GetIndexByte(-2)).GetPrice(!state.IsCharState(), b2, b);
										Encoder.Optimal optimal4 = this._optimum[(int)(num21 + 1U)];
										bool flag29 = false;
										bool flag30 = num25 < optimal4.Price;
										if (flag30)
										{
											optimal4.Price = num25;
											optimal4.PosPrev = num21;
											optimal4.MakeAsChar();
											flag29 = true;
										}
										num9 = price + this._isMatch[(int)((state.Index << 4) + num8)].GetPrice1();
										num10 = num9 + this._isRep[(int)state.Index].GetPrice1();
										bool flag31 = b2 == b && (optimal4.PosPrev >= num21 || optimal4.BackPrev > 0U);
										if (flag31)
										{
											uint num26 = num10 + this.GetRepLen1Price(state, num8);
											bool flag32 = num26 <= optimal4.Price;
											if (flag32)
											{
												optimal4.Price = num26;
												optimal4.PosPrev = num21;
												optimal4.MakeAsShortRep();
												flag29 = true;
											}
										}
										uint num27 = this._matchFinder.GetNumAvailableBytes() + 1U;
										num27 = Math.Min(4095U - num21, num27);
										num4 = num27;
										bool flag33 = num4 < 2U;
										if (!flag33)
										{
											bool flag34 = num4 > this._numFastBytes;
											if (flag34)
											{
												num4 = this._numFastBytes;
											}
											bool flag35 = !flag29 && b2 != b;
											if (flag35)
											{
												uint num28 = Math.Min(num27 - 1U, this._numFastBytes);
												uint matchLen = this._matchFinder.GetMatchLen(0, this.reps[0], num28);
												bool flag36 = matchLen >= 2U;
												if (flag36)
												{
													Base.State state2 = state;
													state2.UpdateChar();
													uint num29 = (position + 1U) & this._posStateMask;
													uint num30 = num25 + this._isMatch[(int)((state2.Index << 4) + num29)].GetPrice1() + this._isRep[(int)state2.Index].GetPrice1();
													uint num31 = num21 + 1U + matchLen;
													while (num12 < num31)
													{
														this._optimum[(int)(num12 += 1U)].Price = 268435455U;
													}
													uint num32 = num30 + this.GetRepPrice(0U, matchLen, state2, num29);
													Encoder.Optimal optimal5 = this._optimum[(int)num31];
													bool flag37 = num32 < optimal5.Price;
													if (flag37)
													{
														optimal5.Price = num32;
														optimal5.PosPrev = num21 + 1U;
											...
											uint num33 = 2U;
											for (uint num34 = 0U; num34 < 4U; num34 += 1U)
											{
												uint num35 = this._matchFinder.GetMatchLen(-1, this.reps[(int)num34], num4);
												bool flag38 = num35 < 2U;
												if (!flag38)
												{
													uint num36 = num35;
													do
													{
														while (num12 < num21 + num35)
														{
															this._optimum[(int)(num12 += 1U)].Price = 268435455U;
														}
														uint num37 = num10 + this.GetRepPrice(num34, num35, state, num8);
														Encoder.Optimal optimal6 = this._optimum[(int)(num21 + num35)];
														bool flag39 = num37 < optimal6.Price;
														if (flag39)
														{
															optimal6.Price = num37;
															optimal6.PosPrev = num21;
															optimal6.BackPrev = num34;
															optimal6.Prev1IsChar = false;
														}
													}
													while ((num35 -= 1U) >= 2U);
													num35 = num36;
													bool flag40 = num34 == 0U;
													if (flag40)
													{
														num33 = num35 + 1U;
													}
													bool flag41 = num35 < num27;
													if (flag41)
													{
														uint num38 = Math.Min(num27 - 1U - num35, this._numFastBytes);
														uint matchLen2 = this._matchFinder.GetMatchLen((int)num35, this.reps[(int)num34], num38);
														bool flag42 = matchLen2 >= 2U;
														if (flag42)
														{
															Base.State state3 = state;
															state3.UpdateRep();
															uint num39 = (position + num35) & this._posStateMask;
															uint num40 = num10 + this.GetRepPrice(num34, num35, state, num8) + this._isMatch[(int)((state3.Index << 4) + num39)].GetPrice0() + this._literalEncoder.GetSubCoder(position + num35, this._matchFinder.GetIndexByte((int)(num35 - 1U - 1U))).GetPrice(true, this._matchFinder.GetIndexByte((int)(num35 - 1U - (this.reps[(int)num34] + 1U))), this._matchFinder.GetIndexByte((int)(num35 - 1U)));
															state3.UpdateChar();
															num39 = (position + num35 + 1U) & this._posStateMask;
															uint num41 = num40 + this._isMatch[(int)((state3.Index << 4) + num39)].GetPrice1();
															uint num42 = num41 + this._isRep[(int)state3.Index].GetPrice1();
															uint num43 = num35 + 1U + matchLen2;
															while (num12 < num21 + num43)
															{
																this._optimum[(int)(num12 += 1U)].Price = 268435455U;
															}
															uint num44 = num42 + this.GetRepPrice(0U, matchLen2, state3, num39);
															Encoder.Optimal optimal7 = this._optimum[(int)(num21 + num43)];
															bool flag43 = num44 < optimal7.Price;
															if (flag43)
															{
																optimal7.Price = num44;
																optimal7.PosPrev = num21 + num35 + 1U;
																optimal7.BackPrev = 0U;
																optimal7.Prev1IsChar = true;
																optimal7.Prev2 = true;
																optimal7.PosPrev2 = num21;
																optimal7.BackPrev2 = num34;
															}
														}
													}
												}
											}
											bool flag44 = num22 > num4;
											if (flag44)
											{
												num22 = num4;
												num3 = 0U;
												while (num22 > this._matchDistances[(int)num3])
												{
													num3 += 2U;
												}
												this._matchDistances[(int)num3] = num22;
												num3 += 2U;
											}
											bool flag45 = num22 >= num33;
											if (flag45)
											{
												num17 = num9 + this._isRep[(int)state.Index].GetPrice0();
												while (num12 < num21 + num22)
												{
													this._optimum[(int)(num12 += 1U)].Price = 268435455U;
												}
												uint num45 = 0U;
												while (num33 > this._matchDistances[(int)num45])
												{
													num45 += 2U;
												}
												uint num46 = num33;
												for (;;)
												{
													uint num47 = this._matchDistances[(int)(num45 + 1U)];
													uint num48 = num17 + this.GetPosLenPrice(num47, num46, num8);
													Encoder.Optimal optimal8 = this._optimum[(int)(num21 + num46)];
													bool flag46 = num48 < optimal8.Price;
													if (flag46)
													{
														optimal8.Price = num48;
														optimal8.PosPrev = num21;
														optimal8.BackPrev = num47 + 4U;
														optimal8.Prev1IsChar = false;
													}
													bool flag47 = num46 == this._matchDistances[(int)num45];
													if (flag47)
													{
														bool flag48 = num46 < num27;
														if (flag48)
														{
															uint num49 = Math.Min(num27 - 1U - num46, this._numFastBytes);
															uint matchLen3 = this._matchFinder.GetMatchLen((int)num46, num47, num49);
															bool flag49 = matchLen3 >= 2U;
															if (flag49)
															{
																Base.State state4 = state;
																state4.UpdateMatch();
																uint num50 = (position + num46) & this._posStateMask;
																uint num51 = num48 + this._isMatch[(int)((state4.Index << 4) + num50)].GetPrice0() + this._literalEncoder.GetSubCoder(position + num46, this._matchFinder.GetIndexByte((int)(num46 - 1U - 1U))).GetPrice(true, this._matchFinder.GetIndexByte((int)(num46 - (num47 + 1U) - 1U)), this._matchFinder.GetIndexByte((int)(num46 - 1U)));
																state4.UpdateChar();
																num50 = (position + num46 + 1U) & this._posStateMask;
																uint num52 = num51 + this._isMatch[(int)((state4.Index << 4) + num50)].GetPrice1();
																uint num53 = num52 + this._isRep[(int)state4.Index].GetPrice1();
																uint num54 = num46 + 1U + matchLen3;
																while (num12 < num21 + num54)
																{
																	this._optimum[(int)(num12 += 1U)].Price = 268435455U;
																}
																num48 = num53 + this.GetRepPrice(0U, matchLen3, state4, num50);
																optimal8 = this._optimum[(int)(num21 + num54)];
																bool flag50 = num48 < optimal8.Price;
																if (flag50)
																{
																	optimal8.Price = num48;
																	optimal8.PosPrev = num21 + num46 + 1U;
																	optimal8.BackPrev = 0U;
																	optimal8.Prev1IsChar = true;
																	optimal8.Prev2 = true;
																	optimal8.PosPrev2 = num21;
																	optimal8.BackPrev2 = num47 + 4U;
																}
															}
														}
														num45 += 2U;
														bool flag51 = num45 == num3;
														if (flag51)
														{
															break;
														}
									...
									return this.Backward(out backRes, num21);
									Block_26:
									this._numDistancePairs = num3;
									this._longestMatchLength = num22;
									this._longestMatchWasFound = true;
									num2 = this.Backward(out backRes, num21);
								}
							}
						}
					}
		...
		// Token: 0x06000099 RID: 153 RVA: 0x00006814 File Offset: 0x00004A14
		private bool ChangePair(uint smallDist, uint bigDist)
		{
			return smallDist < 33554432U && bigDist >= smallDist << 7;
		}

		// Token: 0x0600009A RID: 154 RVA: 0x0000683C File Offset: 0x00004A3C
		...
		// Token: 0x0600009B RID: 155 RVA: 0x00006926 File Offset: 0x00004B26
		...
		// Token: 0x0600009C RID: 156 RVA: 0x00006958 File Offset: 0x00004B58
		...
		// Token: 0x0600009D RID: 157 RVA: 0x00007050 File Offset: 0x00005250
		...
		// Token: 0x0600009E RID: 158 RVA: 0x00007088 File Offset: 0x00005288
		private void SetOutStream(Stream outStream)
		{
			this._rangeEncoder.SetStream(outStream);
		}

		// Token: 0x0600009F RID: 159 RVA: 0x00007098 File Offset: 0x00005298
		private void ReleaseOutStream()
		{
			this._rangeEncoder.ReleaseStream();
		}

		// Token: 0x060000A0 RID: 160 RVA: 0x000070A7 File Offset: 0x000052A7
		...
		// Token: 0x060000A1 RID: 161 RVA: 0x000070B8 File Offset: 0x000052B8
		...
		// Token: 0x060000A2 RID: 162 RVA: 0x0000715C File Offset: 0x0000535C
		...
		// Token: 0x060000A3 RID: 163 RVA: 0x000071CC File Offset: 0x000053CC
		...
		// Token: 0x060000A4 RID: 164 RVA: 0x0000723C File Offset: 0x0000543C
		...
		// Token: 0x060000A5 RID: 165 RVA: 0x000073B0 File Offset: 0x000055B0
		...
		// Token: 0x060000A6 RID: 166 RVA: 0x000073EC File Offset: 0x000055EC
		...
		// Token: 0x060000A7 RID: 167 RVA: 0x0000742C File Offset: 0x0000562C
		...
		// Token: 0x060000A8 RID: 168 RVA: 0x0000771B File Offset: 0x0000591B
		...
		{
			// Token: 0x060000A9 RID: 169 RVA: 0x00007728 File Offset: 0x00005928
			...
			// Token: 0x060000AA RID: 170 RVA: 0x000077B8 File Offset: 0x000059B8
			public void Init()
			{
				uint num = 1U << this.m_NumPrevBits + this.m_NumPosBits;
				for (uint num2 = 0U; num2 < num; num2 += 1U)
			...
			// Token: 0x060000AB RID: 171 RVA: 0x000077FC File Offset: 0x000059FC
			...
			{
				// Token: 0x060000AD RID: 173 RVA: 0x00007839 File Offset: 0x00005A39
				public void Create()
				{
					this.m_Encoders = new BitEncoder[768];
				}

				// Token: 0x060000AE RID: 174 RVA: 0x0000784C File Offset: 0x00005A4C
				public void Init()
				{
					for (int i = 0; i < 768; i++)
					{
				...
				// Token: 0x060000AF RID: 175 RVA: 0x00007880 File Offset: 0x00005A80
				...
				// Token: 0x060000B1 RID: 177 RVA: 0x0000793C File Offset: 0x00005B3C
		...
		{
			// Token: 0x060000B2 RID: 178 RVA: 0x00007A00 File Offset: 0x00005C00
			public LenEncoder()
			{
				for (uint num = 0U; num < 16U; num += 1U)
				{
			...
			// Token: 0x060000B3 RID: 179 RVA: 0x00007A8C File Offset: 0x00005C8C
			...
			// Token: 0x060000B4 RID: 180 RVA: 0x00007AF4 File Offset: 0x00005CF4
		...
		{
			// Token: 0x060000B6 RID: 182 RVA: 0x00007C91 File Offset: 0x00005E91
			public void SetTableSize(uint tableSize)
			{
				this._tableSize = tableSize;
			}

			// Token: 0x060000B7 RID: 183 RVA: 0x00007C9C File Offset: 0x00005E9C
			public uint GetPrice(uint symbol, uint posState)
			{
				return this._prices[(int)(posState * 272U + symbol)];
			}

			// Token: 0x060000B8 RID: 184 RVA: 0x00007CBE File Offset: 0x00005EBE
			...
			// Token: 0x060000B9 RID: 185 RVA: 0x00007CEC File Offset: 0x00005EEC
			...
			// Token: 0x060000BA RID: 186 RVA: 0x00007D14 File Offset: 0x00005F14
		...
		{
			// Token: 0x060000BC RID: 188 RVA: 0x00007D75 File Offset: 0x00005F75
			...
			// Token: 0x060000BD RID: 189 RVA: 0x00007D86 File Offset: 0x00005F86
			...
			// Token: 0x060000BE RID: 190 RVA: 0x00007D98 File Offset: 0x00005F98
