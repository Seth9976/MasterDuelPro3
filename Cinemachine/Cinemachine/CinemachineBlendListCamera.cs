...
namespace Cinemachine
{
	...
	public class CinemachineBlendListCamera : CinemachineVirtualCameraBase
	{
		...
		// (get) Token: 0x06000027 RID: 39 RVA: 0x00002968 File Offset: 0x00000B68
		...
		// (get) Token: 0x06000029 RID: 41 RVA: 0x000029FC File Offset: 0x00000BFC
		// (set) Token: 0x0600002A RID: 42 RVA: 0x00002A04 File Offset: 0x00000C04
		public ICinemachineCamera LiveChild { get; set; }

		// Token: 0x0600002B RID: 43 RVA: 0x00002A0D File Offset: 0x00000C0D
		...
		// (get) Token: 0x0600002C RID: 44 RVA: 0x00002A30 File Offset: 0x00000C30
		...
		// (get) Token: 0x0600002D RID: 45 RVA: 0x00002A38 File Offset: 0x00000C38
		// (set) Token: 0x0600002E RID: 46 RVA: 0x00002A46 File Offset: 0x00000C46
		...
		// (get) Token: 0x0600002F RID: 47 RVA: 0x00002A4F File Offset: 0x00000C4F
		// (set) Token: 0x06000030 RID: 48 RVA: 0x00002A5D File Offset: 0x00000C5D
		...
		public override void InternalUpdateCameraState(Vector3 worldUp, float deltaTime)
		{
			...
			if (best != null)
			{
				...
				if (previousCam != this.LiveChild && this.LiveChild != null)
				{
					...
					if (previousCam != null)
					{
						this.mActiveBlend = base.CreateBlend(previousCam, this.LiveChild, this.m_Instructions[this.mCurrentInstruction].m_Blend, this.mActiveBlend);
		...
		// Token: 0x06000036 RID: 54 RVA: 0x00002D7B File Offset: 0x00000F7B
		...
		// Token: 0x06000037 RID: 55 RVA: 0x00002DA3 File Offset: 0x00000FA3
		private void OnTransformChildrenChanged()
		{
			this.InvalidateListOfChildren();
		}

		// Token: 0x06000038 RID: 56 RVA: 0x00002DAC File Offset: 0x00000FAC
		...
		// (get) Token: 0x0600003A RID: 58 RVA: 0x00002E2E File Offset: 0x0000102E
		...
		// Token: 0x0600003B RID: 59 RVA: 0x00002E39 File Offset: 0x00001039
		...
		private void AdvanceCurrentInstruction(float deltaTime)
		{
			...
			float holdTime = this.m_Instructions[this.mCurrentInstruction].m_Hold + this.m_Instructions[this.mCurrentInstruction].m_Blend.BlendTime;
			float minHold = ((this.mCurrentInstruction < this.m_Instructions.Length - 1 || this.m_Loop) ? 0f : float.MaxValue);
			if (now - this.mActivationTime > Mathf.Max(minHold, holdTime))
			{
				this.mActivationTime = now;
