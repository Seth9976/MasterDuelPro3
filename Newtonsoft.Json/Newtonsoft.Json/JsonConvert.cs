...
namespace Newtonsoft.Json
{
	...
	public static class JsonConvert
	{
		...
		// (get) Token: 0x0600003A RID: 58 RVA: 0x000024B1 File Offset: 0x000006B1
		// (set) Token: 0x0600003B RID: 59 RVA: 0x000024B8 File Offset: 0x000006B8
		...
		// Token: 0x0600003D RID: 61 RVA: 0x000024CC File Offset: 0x000006CC
		...
		// Token: 0x0600003E RID: 62 RVA: 0x0000252C File Offset: 0x0000072C
		public static string ToString(DateTimeOffset value)
		{
			return JsonConvert.ToString(value, DateFormatHandling.IsoDateFormat);
		}

		// Token: 0x0600003F RID: 63 RVA: 0x00002538 File Offset: 0x00000738
		...
		// Token: 0x06000040 RID: 64 RVA: 0x00002590 File Offset: 0x00000790
		...
		// Token: 0x06000041 RID: 65 RVA: 0x000025A0 File Offset: 0x000007A0
		public static string ToString(char value)
		{
			return JsonConvert.ToString(char.ToString(value));
		}

		// Token: 0x06000042 RID: 66 RVA: 0x000025AD File Offset: 0x000007AD
		public static string ToString(Enum value)
		{
			return value.ToString("D");
		}

		// Token: 0x06000043 RID: 67 RVA: 0x000025BA File Offset: 0x000007BA
		public static string ToString(int value)
		{
			return value.ToString(null, CultureInfo.InvariantCulture);
		}

		// Token: 0x06000044 RID: 68 RVA: 0x000025C9 File Offset: 0x000007C9
		public static string ToString(short value)
		{
			return value.ToString(null, CultureInfo.InvariantCulture);
		}

		// Token: 0x06000045 RID: 69 RVA: 0x000025D8 File Offset: 0x000007D8
		[CLSCompliant(false)]
		...
		// Token: 0x06000046 RID: 70 RVA: 0x000025E7 File Offset: 0x000007E7
		[CLSCompliant(false)]
		...
		// Token: 0x06000047 RID: 71 RVA: 0x000025F6 File Offset: 0x000007F6
		public static string ToString(long value)
		{
			return value.ToString(null, CultureInfo.InvariantCulture);
		}

		// Token: 0x06000048 RID: 72 RVA: 0x00002605 File Offset: 0x00000805
		private static string ToStringInternal(BigInteger value)
		{
			return value.ToString(null, CultureInfo.InvariantCulture);
		}

		// Token: 0x06000049 RID: 73 RVA: 0x00002614 File Offset: 0x00000814
		[CLSCompliant(false)]
		...
		// Token: 0x0600004A RID: 74 RVA: 0x00002623 File Offset: 0x00000823
		public static string ToString(float value)
		{
			return JsonConvert.EnsureDecimalPlace((double)value, value.ToString("R", CultureInfo.InvariantCulture));
		}

		// Token: 0x0600004B RID: 75 RVA: 0x0000263D File Offset: 0x0000083D
		...
		// Token: 0x0600004C RID: 76 RVA: 0x00002661 File Offset: 0x00000861
		...
		// Token: 0x0600004E RID: 78 RVA: 0x000026BA File Offset: 0x000008BA
		...
		// Token: 0x0600004F RID: 79 RVA: 0x000026DC File Offset: 0x000008DC
		...
		// Token: 0x06000050 RID: 80 RVA: 0x0000271C File Offset: 0x0000091C
		...
		// Token: 0x06000051 RID: 81 RVA: 0x00002736 File Offset: 0x00000936
		public static string ToString(byte value)
		{
			return value.ToString(null, CultureInfo.InvariantCulture);
		}

		// Token: 0x06000052 RID: 82 RVA: 0x00002745 File Offset: 0x00000945
		[CLSCompliant(false)]
		...
		// Token: 0x06000053 RID: 83 RVA: 0x00002754 File Offset: 0x00000954
		public static string ToString(decimal value)
		{
			return JsonConvert.EnsureDecimalPlace(value.ToString(null, CultureInfo.InvariantCulture));
		}

		// Token: 0x06000054 RID: 84 RVA: 0x00002768 File Offset: 0x00000968
		public static string ToString(Guid value)
		{
			return JsonConvert.ToString(value, '"');
		}

		// Token: 0x06000055 RID: 85 RVA: 0x00002774 File Offset: 0x00000974
		...
		// Token: 0x06000056 RID: 86 RVA: 0x000027A8 File Offset: 0x000009A8
		public static string ToString(TimeSpan value)
		{
			return JsonConvert.ToString(value, '"');
		}

		// Token: 0x06000057 RID: 87 RVA: 0x000027B2 File Offset: 0x000009B2
		internal static string ToString(TimeSpan value, char quoteChar)
		{
			return JsonConvert.ToString(value.ToString(), quoteChar);
		}

		// Token: 0x06000058 RID: 88 RVA: 0x000027C7 File Offset: 0x000009C7
		...
		// Token: 0x06000059 RID: 89 RVA: 0x000027E0 File Offset: 0x000009E0
		internal static string ToString(Uri value, char quoteChar)
		{
			return JsonConvert.ToString(value.OriginalString, quoteChar);
		}

		// Token: 0x0600005A RID: 90 RVA: 0x000027EE File Offset: 0x000009EE
		public static string ToString([Nullable(2)] string value)
		{
			return JsonConvert.ToString(value, '"');
		}

		// Token: 0x0600005B RID: 91 RVA: 0x000027F8 File Offset: 0x000009F8
		...
		// Token: 0x0600005C RID: 92 RVA: 0x00002802 File Offset: 0x00000A02
		...
		// Token: 0x0600005E RID: 94 RVA: 0x00002A07 File Offset: 0x00000C07
		[DebuggerStepThrough]
		...
		// Token: 0x06000060 RID: 96 RVA: 0x00002A1C File Offset: 0x00000C1C
		[DebuggerStepThrough]
		...
		// Token: 0x06000062 RID: 98 RVA: 0x00002A75 File Offset: 0x00000C75
		[NullableContext(2)]
		[DebuggerStepThrough]
		[return: Nullable(1)]
		...
		// Token: 0x06000063 RID: 99 RVA: 0x00002A80 File Offset: 0x00000C80
		[NullableContext(2)]
		[DebuggerStepThrough]
		[return: Nullable(1)]
		...
		// Token: 0x06000064 RID: 100 RVA: 0x00002A9C File Offset: 0x00000C9C
		[NullableContext(2)]
		[DebuggerStepThrough]
		[return: Nullable(1)]
		...
		// Token: 0x06000065 RID: 101 RVA: 0x00002AA8 File Offset: 0x00000CA8
		[NullableContext(2)]
		[DebuggerStepThrough]
		[return: Nullable(1)]
		...
		// Token: 0x06000067 RID: 103 RVA: 0x00002B2C File Offset: 0x00000D2C
		[DebuggerStepThrough]
		[return: Nullable(2)]
		...
		// Token: 0x06000068 RID: 104 RVA: 0x00002B36 File Offset: 0x00000D36
		[DebuggerStepThrough]
		[return: Nullable(2)]
		...
		// Token: 0x06000069 RID: 105 RVA: 0x00002B40 File Offset: 0x00000D40
		[DebuggerStepThrough]
		[return: Nullable(2)]
		...
		// Token: 0x0600006A RID: 106 RVA: 0x00002B4A File Offset: 0x00000D4A
		[NullableContext(2)]
		[DebuggerStepThrough]
		...
		// Token: 0x0600006B RID: 107 RVA: 0x00002B53 File Offset: 0x00000D53
		[DebuggerStepThrough]
		[return: Nullable(2)]
		...
		// Token: 0x0600006C RID: 108 RVA: 0x00002B5B File Offset: 0x00000D5B
		[DebuggerStepThrough]
		[return: Nullable(2)]
		...
		// Token: 0x0600006D RID: 109 RVA: 0x00002B64 File Offset: 0x00000D64
		[DebuggerStepThrough]
		[return: Nullable(2)]
		...
		// Token: 0x0600006E RID: 110 RVA: 0x00002B7C File Offset: 0x00000D7C
		[NullableContext(2)]
		[DebuggerStepThrough]
		...
		// Token: 0x0600006F RID: 111 RVA: 0x00002B94 File Offset: 0x00000D94
		[DebuggerStepThrough]
		[return: Nullable(2)]
		...
		// Token: 0x06000070 RID: 112 RVA: 0x00002BC0 File Offset: 0x00000DC0
		[NullableContext(2)]
		...
		// Token: 0x06000071 RID: 113 RVA: 0x00002C20 File Offset: 0x00000E20
		[DebuggerStepThrough]
		...
		// Token: 0x06000072 RID: 114 RVA: 0x00002C2C File Offset: 0x00000E2C
		...
		// Token: 0x06000074 RID: 116 RVA: 0x00002CA8 File Offset: 0x00000EA8
		...
		// Token: 0x06000075 RID: 117 RVA: 0x00002CCC File Offset: 0x00000ECC
		...
		// Token: 0x06000076 RID: 118 RVA: 0x00002CF7 File Offset: 0x00000EF7
		[return: Nullable(2)]
		...
		// Token: 0x06000077 RID: 119 RVA: 0x00002D00 File Offset: 0x00000F00
		[NullableContext(2)]
		...
		// Token: 0x06000078 RID: 120 RVA: 0x00002D0A File Offset: 0x00000F0A
		[NullableContext(2)]
		...
		// Token: 0x06000079 RID: 121 RVA: 0x00002D18 File Offset: 0x00000F18
		[NullableContext(2)]
		...
		// Token: 0x0600007A RID: 122 RVA: 0x00002D5F File Offset: 0x00000F5F
		public static string SerializeXNode([Nullable(2)] XObject node)
		{
			return JsonConvert.SerializeXNode(node, Formatting.None);
		}

		// Token: 0x0600007B RID: 123 RVA: 0x00002D68 File Offset: 0x00000F68
		...
		// Token: 0x0600007C RID: 124 RVA: 0x00002D74 File Offset: 0x00000F74
		...
		// Token: 0x0600007D RID: 125 RVA: 0x00002D9F File Offset: 0x00000F9F
		[return: Nullable(2)]
		...
		// Token: 0x0600007E RID: 126 RVA: 0x00002DA8 File Offset: 0x00000FA8
		[NullableContext(2)]
		...
		// Token: 0x0600007F RID: 127 RVA: 0x00002DB2 File Offset: 0x00000FB2
		[NullableContext(2)]
