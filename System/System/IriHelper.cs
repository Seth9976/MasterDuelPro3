...
namespace System
{
	...
	{
		// Token: 0x0600047F RID: 1151 RVA: 0x00011EF8 File Offset: 0x000100F8
		internal static bool CheckIriUnicodeRange(char unicode, bool isQuery)
		{
			return (unicode >= '\u00a0' && unicode <= '\ud7ff') || (unicode >= '豈' && unicode <= '﷏') || (unicode >= 'ﷰ' && unicode <= '\uffef') || (isQuery && unicode >= '\ue000' && unicode <= '\uf8ff');
		}

		// Token: 0x06000480 RID: 1152 RVA: 0x00011F50 File Offset: 0x00010150
		internal static bool CheckIriUnicodeRange(char highSurr, char lowSurr, ref bool surrogatePair, bool isQuery)
		{
			...
			{
				surrogatePair = true;
				string text = new string(new char[] { highSurr, lowSurr });
		...
		// Token: 0x06000482 RID: 1154 RVA: 0x0001224C File Offset: 0x0001044C
