...
namespace System.Net.Configuration
{
	...
	public enum UnicodeDecodingConformance
	{
		...
		Auto,
		/// <summary>Use strict behavior. Specifies that the incoming encoded data is checked for validity before being decoded. For example, an input string of "&amp;amp;#144308;" would decode as U+233B4, but an input string of "&amp;amp;#xD84C;&amp;amp;#xDFB4;" would fail to decode properly. Already-decoded data in the string is not checked for validity. For example, an input string of "\ud800" will result in an output string of "\ud800", as thealready-decoded surrogate is skipped during decoding, even though it is unpaired.</summary>
