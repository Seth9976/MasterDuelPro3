...
namespace System
{
	...
	public class OperationCanceledException : SystemException
	{
		...
		// (get) Token: 0x06000A39 RID: 2617 RVA: 0x0002E5EF File Offset: 0x0002C7EF
		// (set) Token: 0x06000A3A RID: 2618 RVA: 0x0002E5F7 File Offset: 0x0002C7F7
		...
		// Token: 0x06000A3B RID: 2619 RVA: 0x0002E600 File Offset: 0x0002C800
		...
		// Token: 0x06000A3C RID: 2620 RVA: 0x0002E618 File Offset: 0x0002C818
		...
		// Token: 0x06000A3D RID: 2621 RVA: 0x0002E62C File Offset: 0x0002C82C
		...
		// Token: 0x06000A3E RID: 2622 RVA: 0x0002E641 File Offset: 0x0002C841
		...
		/// <param name="message">The error message that explains the reason for the exception.</param>
		/// <param name="token">A cancellation token associated with the operation that was canceled.</param>
		// Token: 0x06000A3F RID: 2623 RVA: 0x0002E650 File Offset: 0x0002C850
		...
		/// <param name="innerException">The exception that is the cause of the current exception. If the <paramref name="innerException" /> parameter is not null, the current exception is raised in a catch block that handles the inner exception. </param>
		/// <param name="token">A cancellation token associated with the operation that was canceled.</param>
		// Token: 0x06000A40 RID: 2624 RVA: 0x0002E660 File Offset: 0x0002C860
		...
		// Token: 0x06000A41 RID: 2625 RVA: 0x00018324 File Offset: 0x00016524
