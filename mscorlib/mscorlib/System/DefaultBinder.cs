...
namespace System
{
	...
	{
		// Token: 0x06000EFC RID: 3836 RVA: 0x0003E778 File Offset: 0x0003C978
		public override MethodBase BindToMethod(BindingFlags bindingAttr, MethodBase[] match, ref object[] args, ParameterModifier[] modifiers, CultureInfo cultureInfo, string[] names, out object state)
		{
			...
			if (num == 1)
			{
				...
				if (parametersNoCopy3.Length == args.Length)
				{
					if (array3[0] != null)
					{
						...
						array5[num5] = Array.UnsafeCreateInstance(array3[0], new int[] { 1 });
				...
				else if ((array[0].CallingConvention & CallingConventions.VarArgs) == (CallingConventions)0)
				{
					...
					array7[num6] = Array.UnsafeCreateInstance(array3[0], new int[] { args.Length - num6 });
			...
			if (parametersNoCopy4.Length == args.Length)
			{
				if (array3[num7] != null)
				{
					...
					array8[num9] = Array.UnsafeCreateInstance(array3[num7], new int[] { 1 });
			...
			else if ((array[num7].CallingConvention & CallingConventions.VarArgs) == (CallingConventions)0)
			{
				...
				array10[num10] = Array.UnsafeCreateInstance(array3[num7], new int[] { args.Length - num10 });
		...
		// Token: 0x06000EFD RID: 3837 RVA: 0x0003EF64 File Offset: 0x0003D164
		...
		// Token: 0x06000EFE RID: 3838 RVA: 0x0003F0B4 File Offset: 0x0003D2B4
		...
		// Token: 0x06000EFF RID: 3839 RVA: 0x0003F304 File Offset: 0x0003D504
		public override object ChangeType(object value, Type type, CultureInfo cultureInfo)
		{
			throw new NotSupportedException(Environment.GetResourceString("ChangeType operation is not supported."));
		}

		// Token: 0x06000F00 RID: 3840 RVA: 0x0003F318 File Offset: 0x0003D518
		...
		// Token: 0x06000F01 RID: 3841 RVA: 0x0003F3D4 File Offset: 0x0003D5D4
		...
		// Token: 0x06000F02 RID: 3842 RVA: 0x0003F460 File Offset: 0x0003D660
		...
		// Token: 0x06000F03 RID: 3843 RVA: 0x0003F500 File Offset: 0x0003D700
		...
		// Token: 0x06000F04 RID: 3844 RVA: 0x0003F608 File Offset: 0x0003D808
		...
		// Token: 0x06000F05 RID: 3845 RVA: 0x0003F6F4 File Offset: 0x0003D8F4
		...
		// Token: 0x06000F06 RID: 3846 RVA: 0x0003F754 File Offset: 0x0003D954
		...
		// Token: 0x06000F07 RID: 3847 RVA: 0x0003F79C File Offset: 0x0003D99C
		...
		// Token: 0x06000F08 RID: 3848 RVA: 0x0003F7E4 File Offset: 0x0003D9E4
		...
		// Token: 0x06000F09 RID: 3849 RVA: 0x0003F834 File Offset: 0x0003DA34
		...
		// Token: 0x06000F0A RID: 3850 RVA: 0x0003F85C File Offset: 0x0003DA5C
		...
		// Token: 0x06000F0B RID: 3851 RVA: 0x0003F8A8 File Offset: 0x0003DAA8
		...
		// Token: 0x06000F0C RID: 3852 RVA: 0x0003F8E8 File Offset: 0x0003DAE8
		...
		// Token: 0x06000F0D RID: 3853 RVA: 0x0003F990 File Offset: 0x0003DB90
		...
		// Token: 0x06000F0E RID: 3854 RVA: 0x0003FAC8 File Offset: 0x0003DCC8
		...
		// Token: 0x06000F0F RID: 3855 RVA: 0x0003FAF8 File Offset: 0x0003DCF8
		...
		// Token: 0x06000F10 RID: 3856 RVA: 0x0003FB48 File Offset: 0x0003DD48
		...
		// Token: 0x06000F11 RID: 3857 RVA: 0x0003FD30 File Offset: 0x0003DF30
		private static bool CanChangePrimitive(Type source, Type target)
		{
			return DefaultBinder.CanPrimitiveWiden(source, target);
		}

		// Token: 0x06000F12 RID: 3858 RVA: 0x0003FD3C File Offset: 0x0003DF3C
		...
		{
			// Token: 0x06000F15 RID: 3861 RVA: 0x0003FD89 File Offset: 0x0003DF89
