...
namespace System.Security.Cryptography
{
	...
	public class SHA384Managed : SHA384
	{
		...
		// Token: 0x06002042 RID: 8258 RVA: 0x0008340C File Offset: 0x0008160C
		...
		// Token: 0x06002043 RID: 8259 RVA: 0x00083465 File Offset: 0x00081665
		...
		// Token: 0x06002044 RID: 8260 RVA: 0x00083495 File Offset: 0x00081695
		...
		// Token: 0x06002045 RID: 8261 RVA: 0x000834A0 File Offset: 0x000816A0
		protected override byte[] HashFinal()
		{
			return this._EndHash();
		}

		// Token: 0x06002046 RID: 8262 RVA: 0x000834A8 File Offset: 0x000816A8
		...
		// Token: 0x06002047 RID: 8263 RVA: 0x00083548 File Offset: 0x00081748
		private unsafe void _HashData(byte[] partIn, int ibStart, int cbSize)
		{
			...
			if (num2 > 0 && num2 + i >= 128)
			{
				...
				num += 128 - num2;
				i -= 128 - num2;
				SHA384Managed.SHATransform(ptr3, ptr, ptr2);
				num2 = 0;
			}
			while (i >= 128)
			{
		...
		// Token: 0x06002048 RID: 8264 RVA: 0x00083674 File Offset: 0x00081874
		...
		// Token: 0x06002049 RID: 8265 RVA: 0x00083768 File Offset: 0x00081968
		...
		// Token: 0x0600204A RID: 8266 RVA: 0x00083A85 File Offset: 0x00081C85
		private static ulong RotateRight(ulong x, int n)
		{
			return (x >> n) | (x << 64 - n);
		}

		// Token: 0x0600204B RID: 8267 RVA: 0x00083A97 File Offset: 0x00081C97
		private static ulong Ch(ulong x, ulong y, ulong z)
		{
			return (x & y) ^ ((x ^ ulong.MaxValue) & z);
		}

		// Token: 0x0600204C RID: 8268 RVA: 0x000832FE File Offset: 0x000814FE
		private static ulong Maj(ulong x, ulong y, ulong z)
		{
			return (x & y) ^ (x & z) ^ (y & z);
		}

		// Token: 0x0600204D RID: 8269 RVA: 0x00083AA3 File Offset: 0x00081CA3
		private static ulong Sigma_0(ulong x)
		{
			return SHA384Managed.RotateRight(x, 28) ^ SHA384Managed.RotateRight(x, 34) ^ SHA384Managed.RotateRight(x, 39);
		}

		// Token: 0x0600204E RID: 8270 RVA: 0x00083ABF File Offset: 0x00081CBF
		private static ulong Sigma_1(ulong x)
		{
			return SHA384Managed.RotateRight(x, 14) ^ SHA384Managed.RotateRight(x, 18) ^ SHA384Managed.RotateRight(x, 41);
		}

		// Token: 0x0600204F RID: 8271 RVA: 0x00083ADB File Offset: 0x00081CDB
		private static ulong sigma_0(ulong x)
		{
			return SHA384Managed.RotateRight(x, 1) ^ SHA384Managed.RotateRight(x, 8) ^ (x >> 7);
		}

		// Token: 0x06002050 RID: 8272 RVA: 0x00083AF0 File Offset: 0x00081CF0
		private static ulong sigma_1(ulong x)
		{
			return SHA384Managed.RotateRight(x, 19) ^ SHA384Managed.RotateRight(x, 61) ^ (x >> 6);
		}

		// Token: 0x06002051 RID: 8273 RVA: 0x00083B08 File Offset: 0x00081D08
