...
namespace System.Security.Cryptography
{
	...
	public class SHA256Managed : SHA256
	{
		...
		// Token: 0x0600202E RID: 8238 RVA: 0x00082CA8 File Offset: 0x00080EA8
		...
		// Token: 0x0600202F RID: 8239 RVA: 0x00082CFE File Offset: 0x00080EFE
		...
		// Token: 0x06002030 RID: 8240 RVA: 0x00082D2E File Offset: 0x00080F2E
		...
		// Token: 0x06002031 RID: 8241 RVA: 0x00082D39 File Offset: 0x00080F39
		protected override byte[] HashFinal()
		{
			return this._EndHash();
		}

		// Token: 0x06002032 RID: 8242 RVA: 0x00082D44 File Offset: 0x00080F44
		...
		// Token: 0x06002033 RID: 8243 RVA: 0x00082DC4 File Offset: 0x00080FC4
		...
		// Token: 0x06002034 RID: 8244 RVA: 0x00082ED8 File Offset: 0x000810D8
		...
		// Token: 0x06002035 RID: 8245 RVA: 0x00082FC4 File Offset: 0x000811C4
		...
		// Token: 0x06002036 RID: 8246 RVA: 0x000832E1 File Offset: 0x000814E1
		private static uint RotateRight(uint x, int n)
		{
			return (x >> n) | (x << 32 - n);
		}

		// Token: 0x06002037 RID: 8247 RVA: 0x000832F3 File Offset: 0x000814F3
		private static uint Ch(uint x, uint y, uint z)
		{
			return (x & y) ^ ((x ^ uint.MaxValue) & z);
		}

		// Token: 0x06002038 RID: 8248 RVA: 0x000832FE File Offset: 0x000814FE
		private static uint Maj(uint x, uint y, uint z)
		{
			return (x & y) ^ (x & z) ^ (y & z);
		}

		// Token: 0x06002039 RID: 8249 RVA: 0x0008330B File Offset: 0x0008150B
		private static uint sigma_0(uint x)
		{
			return SHA256Managed.RotateRight(x, 7) ^ SHA256Managed.RotateRight(x, 18) ^ (x >> 3);
		}

		// Token: 0x0600203A RID: 8250 RVA: 0x00083321 File Offset: 0x00081521
		private static uint sigma_1(uint x)
		{
			return SHA256Managed.RotateRight(x, 17) ^ SHA256Managed.RotateRight(x, 19) ^ (x >> 10);
		}

		// Token: 0x0600203B RID: 8251 RVA: 0x00083339 File Offset: 0x00081539
		private static uint Sigma_0(uint x)
		{
			return SHA256Managed.RotateRight(x, 2) ^ SHA256Managed.RotateRight(x, 13) ^ SHA256Managed.RotateRight(x, 22);
		}

		// Token: 0x0600203C RID: 8252 RVA: 0x00083354 File Offset: 0x00081554
		private static uint Sigma_1(uint x)
		{
			return SHA256Managed.RotateRight(x, 6) ^ SHA256Managed.RotateRight(x, 11) ^ SHA256Managed.RotateRight(x, 25);
		}

		// Token: 0x0600203D RID: 8253 RVA: 0x00083370 File Offset: 0x00081570
